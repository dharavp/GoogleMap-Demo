package com.example.admin1.googlemapdemo;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        MarkerOptions marker = (new MarkerOptions().position(new LatLng(17.385044, 78.486671)).title("Marker in Sydney"));
        marker.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN));
        markerPoints.add(new LatLng(17.385044, 78.486671));
    ...
    private void addPath(LatLng latLng) {
        ...
        if (markerPoints.size() >= 2) {
            ...
            Log.d("MapsActivity", "getDirectionsUrl: " + url);
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            try {
                ...
                String totalDist = "Total distance between location is:" +
                        String.valueOf(totalDistance / 1000 + "Km");
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        if (connectionResult.hasResolution()) {
            try {
                ...
                e.printStackTrace();
                Log.e("MapsActivity", "onConnectionFailed: ");
            }
        } else {
            Log.i("MapsActivity", "Location services connection failed with code " + connectionResult.getErrorCode());
        }
    }
